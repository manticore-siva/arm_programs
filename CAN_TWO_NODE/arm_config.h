...
/// SPI block
	...
	struct spi{
		volatile int CR1;       // 0x00
		volatile int CR2;		// 0x04
		volatile int SR;		// 0x08
		volatile int DR;		// 0x0C
		volatile int CRCPR;  	// 0x10
		volatile int RXCRCR;	// 0x14
		volatile int TXCRCR;	// 0x18
		volatile int I2SCFGR;	// 0x1C
		volatile int I2SPR;		// 0x20
	};
	volatile struct spi *SPI1 = (volatile struct spi*)0x40013000;
	volatile struct spi *SPI2 = (volatile struct spi*)0x40003800;
	volatile struct spi *SPI3 = (volatile struct spi*)0x40003C00;
	volatile struct spi *SPI4 = (volatile struct spi*)0x40013400;
